...
export default function TopRated() {
    ...
    const topRatedTab = [
        ...
        {
            name: "Tv Shows",
            api: `https://api.themoviedb.org/3/tv/top_rated?api_key=${apiKey}&language=en-US&page=1`
        }
    ]
                                ...
                                <div key={id} className='relative'>
                                    <div key={id} className='cursor-pointer grid row'>
                                        ...
                                        <Link href={`/tv/tv/${id}`} className="bg-mb-grey pl-4" >
                                            <h2
                                                className='uppercase mt-4  text-sm font-bold text-white' title={displayTitle}
                                            >
                                                {shortTitle}
                                            </h2>
                                            <h2 className='text-white text-sm'>
